...
public class TestSensors extends Sensors {
  ...
  @Override
  public void init() {
    this.leftFrontEncoder = new AbsoluteEncoder(2, 295, true);
    this.rightFrontEncoder = new AbsoluteEncoder(1, 158, true);
    this.leftBackEncoder = new AbsoluteEncoder(3, 10, true);
    this.rightBackEncoder = new AbsoluteEncoder(0, 251, true);
