...
public class SwerveWheel extends RunEachFrameTask {
  ...
  public SwerveWheel(String name, Motor driveMotor, Motor turnMotor, TurnConfiguration pidConfig,
    ...
    DriverStation.reportError(String.format("wheelLoc[0]: %f, wheelLoc[1]: %f, pivotLoc[0]: %f, pivotLoc[1]: %f", this.wheelLoc[0], this.wheelLoc[1], this.pivotLoc[0], this.pivotLoc[1]), false);
